...
function Header() {
    ...
    return (
        <div className='bg-white h-16 px-4 flex justify-between items-center border-b border-green-200'>
                    ...
                    <div>
                        ...
                        >
                         ...
                         hover:text-black text-gray-500 hover:no-underline'>
                            ...
                            {/* <MenuItem className='block rounded-lg py-2 px-3 transition hover:bg-white/5 
                         hover:text-black text-gray-500 hover:no-underline'>
